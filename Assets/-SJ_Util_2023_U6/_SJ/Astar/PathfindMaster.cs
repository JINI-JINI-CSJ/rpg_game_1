...
namespace Pathfinding
{
    ...
    public class PathfindMaster : MonoBehaviour
    {
        ...
        public delegate void PathfindingJobComplete(List<Node_PFind> path);
        ...
        public void RequestPathfind(Node_PFind start, Node_PFind target, PathfindingJobComplete completeCallback)
        {
