...
namespace GridMaster
{
    public class GridBase : MonoBehaviour
    {
        ...
        public Node_PFind[, ,] grid; // our grid
        ...
        public void     Alloc_Grid( int _x , int _y , int _z )
        {
            maxX = _x;
            maxY = _y;
            maxZ = _z;
            ...
            grid = new Node_PFind[maxX, maxY, maxZ];
            ...
            for (int x = 0; x < maxX; x++)
            {
                for (int y = 0; y < maxY; y++)
                {
                    for (int z = 0; z < maxZ; z++)
                    {
                        ...
                        Node_PFind node = new Node_PFind();
                        node.x = x;
                        node.y = y;
                        node.z = z;
        ...
        public void     SetWalkAble( int x , int y , int z , bool b )
        {
            Node_PFind n = GetNode( x, y, z);
            n.isWalkable = b;
        }
        ...
        public Node_PFind GetNode(int x, int y, int z)
        {
